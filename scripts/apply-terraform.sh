...
# if this is running on Windows with WSL, let's transpile all the scripts
...
# ======================================================================
# This script needs to run at least once to setup the project.
...
# Check if the user is logged into their AWS account
# and if it's the same account as the one provided
# in the variables.tfvars file
if [[ -z "$aws_account_id" ]]; then
...
if [[ "$aws_account_id" != "$current_aws_account_id" ]]; then
    print_error "You are not logged into the AWS account $aws_account_id."
    exit 1
fi
...
# ======================================================================
# This script will apply the Terraform configuration for the
...
# ======================================================================
# This script will build and deploy the frontend for the
# specified environment.
